...
Test no_std:    cargo +nightly test -p mantis-core -p mantis-types -p mantis-fixed -p mantis-queue -p mantis-events --no-default-features
...
Miri:           cargo +nightly miri test -p mantis-queue -p mantis-fixed -p mantis-events
