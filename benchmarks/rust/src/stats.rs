...
pub struct LatencyResults {
    ...
    pub cycles_per_op_max: u64,
    pub cycles_per_op_min: u64,
    pub cycles_per_op_mean: f64,
    ...
    pub fn from_histogram(
        ...
        Self {
            ...
            results: LatencyResults {
                ...
                cycles_per_op_max: histogram.max(),
                cycles_per_op_min: histogram.min(),
                cycles_per_op_mean: histogram.mean(),
